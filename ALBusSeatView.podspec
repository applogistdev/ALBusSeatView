...
Pod::Spec.new do |s|
    ...
    s.screenshots      = 'https://github.com/applogistdev/ALBusSeatView/blob/screenshot/Screenshots/ss1.png', 'https://github.com/applogistdev/ALBusSeatView/blob/screenshot/Screenshots/ss2.png'
